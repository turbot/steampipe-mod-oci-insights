dashboard "oci_block_storage_boot_volume_faulty_report" {

  title = "OCI Block Storage Boot Volume Faulty Report"
...
query "oci_block_storage_boot_volume_faulty_table" {
  sql = <<-EOQ
      select
