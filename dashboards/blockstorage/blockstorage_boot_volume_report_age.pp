dashboard "blockstorage_boot_volume_age_report" {
  ...
  container {
    ...
    card {
      query = query.blockstorage_boot_volume_24_hrs
      width = 2
      type  = "info"
    }

    card {
      query = query.blockstorage_boot_volume_30_days
      width = 2
      type  = "info"
    }

    card {
      query = query.blockstorage_boot_volume_90_days
      width = 2
      type  = "info"
    }

    card {
      query = query.blockstorage_boot_volume_365_days
      width = 2
      type  = "info"
    }

    card {
      query = query.blockstorage_boot_volume_1_year
      width = 2
      type  = "info"
    }
  ...
  table {
    ...
    query = query.blockstorage_boot_volume_age_report
  }
